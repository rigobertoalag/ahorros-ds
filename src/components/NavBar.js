...
export default function NavBar() {
    return (
        <div>
            <nav className="bg-pink-400 shadow fixed max-w-screen-md z-10 mx-auto inset-x-0 top-0 ">

                <div className="">
                    <button id="mobileMenuButton" className="p-3 focus:outline-none md:hidden pr-40" title="Open side menu">
                    ...
                    <a href="#" className="font-extrabold m-3 uppercase inline-flex hover:text-pink-700 transition-all duration-500 pr-0">
