    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 justify-items-center items-center mt-2">
                <label for="price" className="block text-xl font-medium text-gray-700">Añadir ahorro</label>
                ...
                <a role="button" className="bg-pink-500 hover:bg-pink-600 text-white text-xl px-10 py-4 border rounded-full mt-5">
                    Añadir ahorro
            </a>
            </div>
        </>
